...
export class Slice extends CyHand {
    ...
    constructor(owner: Clockface, name: string, radix: number, bg_color: number, color: number, phase: number, length_pct: number, offset_pct: number, width: number) {
        super(owner, name, radix, color, phase, length_pct, offset_pct);
